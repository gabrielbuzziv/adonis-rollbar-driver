...
module.exports = {
  ...
  */
  ...
  logger: {
    ...
    |
    | Available drivers are: `file`, `rollbar` and `console`.
    |
    */
    transport: 'rollbar',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Rollbar transport uses our custom rollbar driver to log messages for
    | our rollbar service via sdk.
    |
    */
    rollbar: {
      driver: 'rollbar',
      ...
      level: 'warning',
      rollbarConfig: {
        accessToken: Env.get('ROLLBAR_ACCESS_TOKEN', null)
      }
    }
  },
